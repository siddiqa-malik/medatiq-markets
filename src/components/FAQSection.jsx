  ...
  return (
    <section className="container py-20 px-4">
      <div className="max-w-7xl mx-auto">
          ...
          {faqData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="font-semibold text-[#0c1c24] text-sm md:text-base">
                    {item.question}
                  </span>
                  <span
                    className={`shrink-0 w-6 h-6 flex items-center justify-center text-xl text-[#0c1c24] transition-transform duration-300 ${
        ...
        <div className="mt-10 bg-[#021d30] rounded-3xl px-6 py-10 text-center">
          ...
          <button className="border border-white text-white text-sm font-medium px-8 py-3 rounded-full hover:bg-white hover:text-[#021d30] transition-all duration-300">
            Get in touch
          </button>
        </div>
      </div>
